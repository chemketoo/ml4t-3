...
if __name__=="__main__": 			  		 			 	 	 		 		 	  		   	  			  	
    #seed = np.linspace(1, 1000)
    # linear seems good. are seeds always positive?
    # 43/50 for DT.
    ...
    i = 0
    for s in seed:
        success[i] = test_code(seed=1234567)
        i +=1
    print(np.count_nonzero(success))
    print("out of " + str(len(seed)))	 			 	